...
import { UploadProductContext } from "../../context/UploadProductContext";
...
export const Login = () => {
  ...
  const { login, auths, success } = useContext(AuthContext)
  const { display } = useContext(UploadProductContext)
  ...
  return (
    <div className="w-full h-[100vh] relative">
      <div className="flex">
        ...
        <div className="hidden bg-[#0055D4] text-white font-Raleway w-[40%] h-[100vh] sm:flex justify-between items-center flex-col py-[3rem] text-center">
          ...
          <div>
            ...
            <Link to="/sign_up">
              <button className="bg-white text-[#0055D4] w-[12rem] h-[3rem] font-[600]">
                CREATE ACCOUNT
              </button>
            </Link>
          </div>
        ...
        <div className="bg-white w-full sm:w-[70%] h-[100vh] text-center py-[3rem] flex flex-col justify-center">
          ...
          <form onSubmit={handleFormSubmit} className="font-Poppins">
            ...
            <div className="w-full px-6 mb-4">
              <input
                className="w-full h-10 px-3 py-6 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline"
                type="text"
            ...
            <div className="mt-[3rem] mb-[2rem] px-6 sm:px-0">
              By creating an account you agree to our{" "}
              <span className="text-[#0055D4] font-[500]">
                TERMS & CONDITION
              </span>{" "}
              and{" "}
              <span className="text-[#0055D4] font-[500]">PRIVACY POLICY</span>
            </div>

            <button className="w-[15rem] bg-[#0055D4] h-[4rem] text-white">
              LOGIN
            </button>
            ...
            <div className="sm:hidden flex justify-center mt-6">
              ...
              <Link to="/sign_up">
                <span className="text-[#0055D4] font-[600] ml-2 uppercase">
                  Create account
                </span>
              </Link>
            </div>
      ...
      {/* modal */}
      <div className={`${!auths ? 'hidden': 'flex'} absolute top-0 w-full h-[100vh]  justify-center items-center`} style={{background: 'rgba(0,0,0,0.555)'}}>
